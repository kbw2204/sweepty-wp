...
const callbackURL = (process.env.NODE_ENV == 'production')?
  'https://pacific-tundra-51413.herokuapp.com/auth/facebook/callback':
  'http://localhost:3000/auth/facebook/callback'
  passport.use(new FacebookStrategy({
    // 이 부분을 여러분 Facebook App의 정보로 수정해야 합니다.
    clientID : process.env.FBID || '1863190500638262',
    clientSecret : process.env.FB_SECRET ||'3f7b31d8f75bb7228462eb5bfb7159dd',
